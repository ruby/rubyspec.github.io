 ...
 # <code>default.mspec</code>
 # depending on RUBY_VERSION, either <code>ruby.1.8.mspec</code> or <code>ruby.1.9.mspec</code>
 # <code>~/.mspecrc</code>
 ...
 h3. Loading configuration files
 ...
 h3. Invoking the runner scripts
 ...
 h3. Selecting the set of specs to run by filters
 ...
 h3. Selecting the set of specs to run by explicit lists of files
 ...
 # a simple file name
 # a directory name, in which case the directory is recursively searched for spec files (i.e. dir/**/*_spec.rb)
 # a glob pattern understood by <code>Dir[]</code>.
